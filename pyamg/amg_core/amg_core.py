...
def dense_GMRES(*args):
    """
    dense_GMRES(float [] A, float [] b, float [] x, int const n, int const is_col_major, int maxiter=10, int precondition=1)
    dense_GMRES(float [] A, float [] b, float [] x, int const n, int const is_col_major, int maxiter=10)
    dense_GMRES(float [] A, float [] b, float [] x, int const n, int const is_col_major)
    dense_GMRES(double [] A, double [] b, double [] x, int const n, int const is_col_major, int maxiter=10, int precondition=1)
    dense_GMRES(double [] A, double [] b, double [] x, int const n, int const is_col_major, int maxiter=10)
    dense_GMRES(double [] A, double [] b, double [] x, int const n, int const is_col_major)
    """
    return _amg_core.dense_GMRES(*args)
...
def jacobi_indexed(*args):
    """
    jacobi_indexed(int const [] Ap, int const [] Aj, float const [] Ax, float [] x, float const [] b, int const [] indices, float const [] omega)
    jacobi_indexed(int const [] Ap, int const [] Aj, double const [] Ax, double [] x, double const [] b, int const [] indices, double const [] omega)
    jacobi_indexed(int const [] Ap, int const [] Aj, std::complex< float > const [] Ax, std::complex< float > [] x, std::complex< float > const [] b, int const [] indices, std::complex< float > const [] omega)
    jacobi_indexed(int const [] Ap, int const [] Aj, std::complex< double > const [] Ax, std::complex< double > [] x, std::complex< double > const [] b, int const [] indices, std::complex< double > const [] omega)
    """
    return _amg_core.jacobi_indexed(*args)

def boundary_relaxation(*args):
    """
    ...
    """
    return _amg_core.boundary_relaxation(*args)
...
def bsr_jacobi_indexed(*args):
    """
    bsr_jacobi_indexed(int const [] Ap, int const [] Aj, float const [] Ax, float [] x, float const [] b, int const [] indices, int const blocksize, float const [] omega)
    bsr_jacobi_indexed(int const [] Ap, int const [] Aj, double const [] Ax, double [] x, double const [] b, int const [] indices, int const blocksize, double const [] omega)
    bsr_jacobi_indexed(int const [] Ap, int const [] Aj, std::complex< float > const [] Ax, std::complex< float > [] x, std::complex< float > const [] b, int const [] indices, int const blocksize, std::complex< float > const [] omega)
    bsr_jacobi_indexed(int const [] Ap, int const [] Aj, std::complex< double > const [] Ax, std::complex< double > [] x, std::complex< double > const [] b, int const [] indices, int const blocksize, std::complex< double > const [] omega)
    """
    return _amg_core.bsr_jacobi_indexed(*args)
...
def block_jacobi_indexed(*args):
    """
    block_jacobi_indexed(int const [] Ap, int const [] Aj, float const [] Ax, float [] x, float const [] b, float const [] Tx, int const [] indices, float const [] omega, int const blocksize)
    block_jacobi_indexed(int const [] Ap, int const [] Aj, double const [] Ax, double [] x, double const [] b, double const [] Tx, int const [] indices, double const [] omega, int const blocksize)
    block_jacobi_indexed(int const [] Ap, int const [] Aj, std::complex< float > const [] Ax, std::complex< float > [] x, std::complex< float > const [] b, std::complex< float > const [] Tx, int const [] indices, std::complex< float > const [] omega, int const blocksize)
    block_jacobi_indexed(int const [] Ap, int const [] Aj, std::complex< double > const [] Ax, std::complex< double > [] x, std::complex< double > const [] b, std::complex< double > const [] Tx, int const [] indices, std::complex< double > const [] omega, int const blocksize)
    """
    return _amg_core.block_jacobi_indexed(*args)
...
def one_point_interpolation(*args):
    """
    one_point_interpolation(int [] rowptr, int [] colinds, float [] data, int const [] C_rowptr, int const [] C_colinds, float const [] C_data, int const [] splitting)
    one_point_interpolation(int [] rowptr, int [] colinds, double [] data, int const [] C_rowptr, int const [] C_colinds, double const [] C_data, int const [] splitting)
    """
