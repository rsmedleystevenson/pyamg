...
<<<<<<< HEAD
=======
_amg_core.PRE_F_NODE_swigconstant(_amg_core)
...
def rs_boundary_smoothing_interpolation_pass1(n_nodes, Sp, Sj, splitting, Bp):
    """rs_boundary_smoothing_interpolation_pass1(int const n_nodes, int const [] Sp, int const [] Sj, int const [] splitting, int [] Bp)"""
    return _amg_core.rs_boundary_smoothing_interpolation_pass1(n_nodes, Sp, Sj, splitting, Bp)

def rs_boundary_smoothing_interpolation_pass2(*args):
    """
