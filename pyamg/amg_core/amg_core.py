...
class FloatVector(_object):
    ...
    def __getslice__(self, i, j):
        ...
        return _amg_core.FloatVector___getslice__(self, i, j)
    ...
    def __delslice__(self, i, j):
        ...
        return _amg_core.FloatVector___delslice__(self, i, j)
    ...
    def append(self, x):
        ...
        return _amg_core.FloatVector_append(self, x)
    ...
    def swap(self, v):
        ...
        return _amg_core.FloatVector_swap(self, v)
    ...
    def push_back(self, x):
        ...
        return _amg_core.FloatVector_push_back(self, x)
    ...
    def assign(self, n, x):
        ...
        return _amg_core.FloatVector_assign(self, n, x)
    ...
    def reserve(self, n):
        ...
        return _amg_core.FloatVector_reserve(self, n)
...
class ComplexFloatVector(_object):
    ...
    def __getslice__(self, i, j):
        ...
        return _amg_core.ComplexFloatVector___getslice__(self, i, j)


    def __setslice__(self, *args):
        """
        __setslice__(ComplexFloatVector self, std::vector< std::complex< float > >::difference_type i, std::vector< std::complex< float > >::difference_type j, ComplexFloatVector v)
    ...
    def __delslice__(self, i, j):
        ...
        return _amg_core.ComplexFloatVector___delslice__(self, i, j)
    ...
    def append(self, x):
        ...
        return _amg_core.ComplexFloatVector_append(self, x)
    ...
    def swap(self, v):
        ...
        return _amg_core.ComplexFloatVector_swap(self, v)
    ...
    def push_back(self, x):
        ...
        return _amg_core.ComplexFloatVector_push_back(self, x)
    ...
    def assign(self, n, x):
        ...
        return _amg_core.ComplexFloatVector_assign(self, n, x)
    ...
    def insert(self, *args):
        ...
        insert(ComplexFloatVector self, std::vector< std::complex< float > >::iterator pos, std::vector< std::complex< float > >::size_type n, std::vector< std::complex< float > >::value_type const & x)
        """
    ...
    def reserve(self, n):
        ...
        return _amg_core.ComplexFloatVector_reserve(self, n)
...
class ComplexDoubleVector(_object):
    ...
    def __getslice__(self, i, j):
        ...
        return _amg_core.ComplexDoubleVector___getslice__(self, i, j)
    ...
    def __delslice__(self, i, j):
        ...
        return _amg_core.ComplexDoubleVector___delslice__(self, i, j)
    ...
    def append(self, x):
        ...
        return _amg_core.ComplexDoubleVector_append(self, x)
    ...
    def swap(self, v):
        ...
        return _amg_core.ComplexDoubleVector_swap(self, v)
    ...
    def push_back(self, x):
        ...
        return _amg_core.ComplexDoubleVector_push_back(self, x)
    ...
    def assign(self, n, x):
        ...
        return _amg_core.ComplexDoubleVector_assign(self, n, x)
    ...
    def reserve(self, n):
        ...
        return _amg_core.ComplexDoubleVector_reserve(self, n)
...
class PairVectorDouble(_object):
    ...
    if _newclass:
        first = _swig_property(_amg_core.PairVectorDouble_first_get, _amg_core.PairVectorDouble_first_set)
    ...
    if _newclass:
        second = _swig_property(_amg_core.PairVectorDouble_second_get, _amg_core.PairVectorDouble_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
...
class PairVectorFloat(_object):
    ...
    if _newclass:
        first = _swig_property(_amg_core.PairVectorFloat_first_get, _amg_core.PairVectorFloat_first_set)
    ...
    if _newclass:
        second = _swig_property(_amg_core.PairVectorFloat_second_get, _amg_core.PairVectorFloat_second_set)
    def __len__(self):
        return 2
    def __repr__(self):
        return str((self.first, self.second))
...
def constrained_least_squares(*args):
    """
    constrained_least_squares(FloatVector A, FloatVector b, FloatVector C, FloatVector d, int const & m, int const & n, int const & s) -> FloatVector
    constrained_least_squares(DoubleVector A, DoubleVector b, DoubleVector C, DoubleVector d, int const & m, int const & n, int const & s) -> DoubleVector
    """
...
def ben_ideal_interpolation(*args):
    """
    ben_ideal_interpolation(int const [] A_rowptr, int const [] A_colinds, float const [] A_data, int const [] S_rowptr, int const [] S_colinds, int [] P_rowptr, float const [] B, int const [] Cpts, int const n, int const num_bad_guys) -> PairVectorFloat
    ben_ideal_interpolation(int const [] A_rowptr, int const [] A_colinds, double const [] A_data, int const [] S_rowptr, int const [] S_colinds, int [] P_rowptr, double const [] B, int const [] Cpts, int const n, int const num_bad_guys) -> PairVectorDouble
    """
