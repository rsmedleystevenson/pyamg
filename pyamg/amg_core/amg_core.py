...
def drake_matching(A_rowptr, A_rowptr_size, A_colinds, A_colinds_size, A_data, A_data_size, Agg_rowptr, Agg_rowptr_size, Agg_colinds, Agg_colinds_size, Agg_shape, Agg_shape_size, dummy=0):
    """
    ...
    """
    return _amg_core.drake_matching(A_rowptr, A_rowptr_size, A_colinds, A_colinds_size, A_data, A_data_size, Agg_rowptr, Agg_rowptr_size, Agg_colinds, Agg_colinds_size, Agg_shape, Agg_shape_size, dummy)

def notay_pairwise(A_rowptr, A_rowptr_size, A_colinds, A_colinds_size, A_data, A_data_size, Agg_rowptr, Agg_rowptr_size, Agg_colinds, Agg_colinds_size, Agg_shape, Agg_shape_size, beta=0):
    """
    ...
    """
    return _amg_core.notay_pairwise(A_rowptr, A_rowptr_size, A_colinds, A_colinds_size, A_data, A_data_size, Agg_rowptr, Agg_rowptr_size, Agg_colinds, Agg_colinds_size, Agg_shape, Agg_shape_size, beta)
