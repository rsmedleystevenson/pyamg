...
template<class I, class T>
void drake_matching(const I A_rowptr[],
                    const I A_colinds[],
                    const T A_data[],
                    const I n,
                    const I order,
                    ...
                    I S[] )
{
    I bottom_loop,
      top_loop,
      step;
    // Loop through matrix DOFs forward
    if (order == 0) {
        bottom_loop = 0;
        top_loop = n;
        step = 1;
    }
    // Loop through matrix DOFs backward
    else {
        bottom_loop = n-1;
        top_loop = -1;
        step = -1;
    ...
    // Form two matchings, M1, M2
    for (I row=bottom_loop; row!=top_loop; row+=step) {
        I x = row;
        while (true) {
